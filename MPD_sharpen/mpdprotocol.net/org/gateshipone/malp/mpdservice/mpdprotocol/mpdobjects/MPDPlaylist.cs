...
{
	public class MPDPlaylist : org.gateshipone.malp.mpdservice.mpdprotocol.mpdobjects.MPDFileEntry
		, org.gateshipone.malp.mpdservice.mpdprotocol.mpdobjects.MPDGenericItem
	{
		...
		public virtual int compareTo(org.gateshipone.malp.mpdservice.mpdprotocol.mpdobjects.MPDPlaylist
			 another)
		{
			if (another == null)
			{
