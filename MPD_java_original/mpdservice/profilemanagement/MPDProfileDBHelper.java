...
public class MPDProfileDBHelper extends SQLiteOpenHelper{
     ...
     * M.Schleinkofer 03.06.2017: changed to version 3
     */
    ...
    public void onUpgrade(SQLiteDatabase database, int oldVersion, int newVersion) {
        ...
        switch ( oldVersion ) {
            // Upgrade from version 1 to 3 needs introduction of the streaming port and streaming
            // enable column as well as the rating columns
            case 1: {
                ...
                sqlString = "ALTER TABLE " + MPDServerProfileTable.SQL_TABLE_NAME + " ADD COLUMN " + MPDServerProfileTable.COLUMN_RATING_HOSTNAME + " text;";
                database.execSQL(sqlString);

                sqlString = "ALTER TABLE " + MPDServerProfileTable.SQL_TABLE_NAME + " ADD COLUMN " + MPDServerProfileTable.COLUMN_RATING_PORT + " integer;";
                database.execSQL(sqlString);

                sqlString = "ALTER TABLE " + MPDServerProfileTable.SQL_TABLE_NAME + " ADD COLUMN " + MPDServerProfileTable.COLUMN_RATING_ENABLED + " integer;";
                database.execSQL(sqlString);
            }
            case 2: {
                String sqlString = "ALTER TABLE " + MPDServerProfileTable.SQL_TABLE_NAME + " ADD COLUMN " + MPDServerProfileTable.COLUMN_RATING_HOSTNAME + " text;";
                database.execSQL(sqlString);
