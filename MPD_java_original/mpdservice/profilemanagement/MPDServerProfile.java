...
public class MPDServerProfile implements MPDGenericItem, Parcelable {
    ...
    private String mRatingHostname = "";
    private int mRatingPort;
    ...
    protected MPDServerProfile(Parcel in) {
        ...
        mRatingHostname = in.readString();
        mRatingPort = in.readInt();
        mRatingEnabled = in.readInt() == 1;
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(mRatingHostname);
        dest.writeInt(mRatingPort);
        dest.writeInt(mRatingEnabled ? 1 : 0);
    }
    ...
    public String getRatingHostname() {
        return mRatingHostname;
    }

    public void setRatingHostname(String mRatingHostname) {
        this.mRatingHostname = mRatingHostname;
    }

    public int getRatingPort() {
        return mRatingPort;
    }

    public void setRatingPort(int mRatingPort) {
        this.mRatingPort = mRatingPort;
    }

    public boolean isRatingEnabled() {
        return mRatingEnabled;
    }

    public void setRatingEnabled(boolean mRatingEnabled) {
        this.mRatingEnabled = mRatingEnabled;
    }
}
