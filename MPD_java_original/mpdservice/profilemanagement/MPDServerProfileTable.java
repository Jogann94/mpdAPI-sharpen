...
public class MPDServerProfileTable {
    ...
    public static final String COLUMN_RATING_HOSTNAME = "rating_hostname";
    public static final String COLUMN_RATING_PORT = "rating_port";
    public static final String COLUMN_RATING_ENABLED = "rating_enabled";
    ...
    public static final String[] PROJECTION_SERVER_PROFILES = {COLUMN_PROFILE_NAME, COLUMN_PROFILE_AUTO_CONNECT,
        COLUMN_SERVER_HOSTNAME, COLUMN_SERVER_PASSWORD, COLUMN_SERVER_PORT, COLUMN_PROFILE_DATE_CREATED,
            ...
            COLUMN_RATING_HOSTNAME, COLUMN_RATING_PORT, COLUMN_RATING_ENABLED
    };
    ...
    public static final String DATABASE_CREATE = "create table if not exists " +  SQL_TABLE_NAME + " (" +
            ...
            COLUMN_RATING_HOSTNAME + " text," + COLUMN_RATING_PORT + " integer, " + COLUMN_RATING_ENABLED + " integer"+" );";
